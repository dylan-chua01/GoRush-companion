...
// Language Resources
const languageResources_practical = {
  en: {
    welcome: "Hello, I'm Gorra 📋\nLet's tackle your challenges with clear, actionable steps. What do you need help solving today?",
  ...
  ms: {
    welcome: "Helo, saya Gorra 📋\nMari selesaikan masalah anda dengan langkah praktikal. Anda perlukan bantuan dengan apa hari ini?",
...
export default function App() {
  ...
  const t = (key) => {
    return languageResources_practical[currentLanguage][key] || key;
  };
  ...
  const callGeminiAPI = async () => {
    ...
    if (isGoRushQuery) {
      ...
      const systemPrompt_practical = currentLanguage === 'ms' 
        ? `Anda seorang rakan yang praktikal dan berfikir secara logik. Anda mendengar dengan teliti dan membantu pengguna menganalisis situasi serta mencadangkan tindakan yang realistik. Anda seperti kawan yang tahu apa nak buat. Jawapan anda hendaklah:
        ...
        : `You are a practical, solution-oriented friend. You listen carefully and help the user analyze their situation, offering realistic steps forward. You're like that friend who knows what to do. Your responses should be:
      ...
      const payload = {
        contents: [
          {
            role: "user",
            parts: [{ text: systemPrompt_practical }]
          },
          ...conversationHistory,
          {
            role: "user",
